...
exports.validateBusinessInfo = (req, res, next) => {
          ...
          req.check(
                    ...
                    'Business register number is required'
          ).notEmpty();
          // check for errors
          const errors = req.validationErrors();
          // if error show the first one as they happen
...
exports.validateProduct = async (req, res, next) => {
          ...
          req.check(
                    'return',
                    'Product returning time peroid required'
          ).notEmpty();
          req.check(
                    'description',
          ...
          req.check('availableDistricts', 'Invalid districts.').custom(
                    (values) => {
                              let dts = values
